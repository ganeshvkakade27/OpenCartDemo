...
public class ExtentReportManger implements ITestListener  {
		...
		public void onStart(ITestContext context) 
		{
			...
			*/
			...
			spartreprt.config().setDocumentTitle("CFMS Automation Report");
			spartreprt.config().setReportName("Partner portal Admin ");
			...
			extentR.setSystemInfo("Portal", "Partner Admin Portal");
